...
void Game::play(){
    ...
    do {
        ...
        if (goPl == 2) {
            ...
            //make false usb info and the item info, so we can make a new game starts with new one.
            you->setHasUSB(false);
            ...
            //make first, second, and third search info of rooms so that a new game starts from the beginning.
