        ...
        if(!doneF) {
            ...
            if(getIsUSB() && hiddenP == 1) {
               ...
               cha->setHasUSB(true);
                ...
                std::cout << "USB is not here. But some energy drink is here?" << std::endl;
                std::cout << "You drank it got  energy so strength 2 added" << std::endl;
                std::cout << "You really need this." << std::endl;
