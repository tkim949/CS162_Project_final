        ...
        if(count == 0 ) {
            ...
            if(!doneF) {
                ...
                if(getIsUSB() && hiddenP == 3) {
                    ...
                    std::cout << "What is it in the bottom?" << std::endl;
                    std::cout << "Oh yes! It's chocolate." << std::endl;
                    std::cout << "You ate that chocolate and got energy 2. You really need this one" << std::endl;
